...
//_____________________________________________111___chat______________________
        cardView1 = findViewById(R.id.edit_rendivu);
...
//_________________________________________   02222_______tasjil01______________________
        cardView2 = findViewById(R.id.add_rendivu);
        ...
        cardView4 = findViewById(R.id.cancel_rendivu);
...
//*****************************4444_______________________
        ...
        cardView3 = findViewById(R.id.i3ref_akter);
        cardView3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent3 = new Intent(MainActivity.this, program_vac_DZ.class);
        ...
        cardView5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent3 = new Intent(MainActivity.this, demmande_certaficat.class);
                startActivity(intent3);

                                    ...
                                    reference.setValue(users).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if(task.isSuccessful())
                                            {
                                                ...
                                                Toast.makeText(com.example.user__admin.SettingActivity.this, "Data Successfully Updated", Toast.LENGTH_SHORT).show();
                                                startActivity(new Intent(com.example.user__admin.SettingActivity.this,HomeActivity.class));
                                            }
                                            else {
                                                progressDialog.dismiss();

                                                Toast.makeText(com.example.user__admin.SettingActivity.this, "Something Went Wrong", Toast.LENGTH_SHORT).show();
                                            }
                                        }
                                    });
                                }
